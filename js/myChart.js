        ...
        series: [
            {
                ...
                radius: ["40%", "60%"],
                // 不显示标签文字
                label: { show: true, color: '#aaa', fontSize: 10 },
                // 不显示连接线
                labelLine: { show: true },
                data: [
                    { value: 1, name: "0岁以下" },
...
(function () {
    ...
    let option = {
        color: ['#006cff', '#60cda0', '#ed8884', '#ff9f7f', '#0096ff', '#9fe6b8', '#32c5e9', '#1d9dff'], color: ['#006cff', '#60cda0', '#ed8884', '#ff9f7f', '#0096ff', '#9fe6b8', '#32c5e9', '#1d9dff'],
        tooltip: {
            trigger: 'item',
            // formatter: '{a} <br/>{b} : {c} ({d}%)'
        },
